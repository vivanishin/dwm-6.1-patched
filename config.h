...
static const char *fonts[] = {
	"Inconsolata LGC:size=8:antialias=true:autohint=true"
};
static const char dmenufont[]       = "Inconsolata LGC:size=8:antialias=true:autohint=true";
